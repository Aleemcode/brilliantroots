...
export function Methodology() {
  return (
    <Section id="method" background="bg">
        ...
        <div className="mb-20 max-w-3xl">
          ...
          <AnimateIn delay={0.2}>
            <p className="text-lg text-br-muted leading-relaxed max-w-2xl">
              The goal is not to make Islamic learning feel like another stream of content. The goal is 
              to help the home preserve what is true, practice what is beneficial, and choose with purpose.
            </p>
          </AnimateIn>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          ...
          <AnimateIn delay={0.3}>
            <div className="h-full bg-br-card rounded-2xl p-8 border border-br-border shadow-sm dark:shadow-none">
              ...
              <ul className="space-y-6">
                {[
                  "Content arrives before the parent has a clear intention",
                  "Products compete for attention without a household rhythm",
          ...
          <AnimateIn delay={0.4}>
            <div className="h-full bg-br-primary-soft rounded-2xl p-8 border border-br-primary/20 shadow-sm dark:shadow-none">
              ...
              <ul className="space-y-6">
                {[
                  "Clarify the intention before choosing the material",
                  "Build repeatable family rhythms before adding more",
                  "Choose tools that serve a real stage in the home",
